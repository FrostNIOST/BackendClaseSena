export default class User { // Clase modelo que representa un usuario; estructura los datos del backend para usar en el frontend
  constructor({ // Constructor con desestructuración; crea una instancia User a partir del objeto JSON de la API
    ...
    phone = '', // Número de teléfono opcional; solo números, longitud entre 7 y 15 caracteres
    role = 'user' // Rol del usuario en el sistema; valor por defecto 'auxiliar' (el rol de menor privilegio)
    ...
    this.phone = phone; // Asigna el teléfono a la instancia; se muestra en perfil y formularios
